...
uses
  ...
  cxDBData, cxSpinEdit, cxDBExtLookupComboBox, cxCalc, cxCurrencyEdit,
  cxCalendar, cxImageComboBox, cxMemo, cxDBEdit, cxPC, cxGridLevel,
  cxGridCustomTableView, cxGridTableView, cxGridDBTableView, cxClasses,
  cxControls, cxGridCustomView, cxGrid, cxLookupEdit, cxDBLookupEdit,
  cxDropDownEdit, ZAbstractRODataset, ZAbstractDataset, ZDataset, ExtCtrls,
  dxDockControl, untIvPositionDevExpress, untIvPositionStandard, DBActns,
  ActnList, cxContainer, cxTextEdit, cxMaskEdit, StdCtrls, dxDockPanel,
  cxButtons, cxProgressBar, dxSkinBlack, dxSkinBlue, dxSkinCaramel,
...
type
  TfmCouple = class(TFormUniTransactionEx)
    ...
    qryTransactionDt: TZQuery;
    dsTransactionDt: TDataSource;
    qryGetStatusItem: TZQuery;
    qryGetItemDetail: TZQuery;
    qryDeleteDetail: TZQuery;
    qryInsertDetail: TZQuery;
    qryUpdateCOGSCoupleHd: TZQuery;
    pnTop: TPanel;
    ...
    cgvCoupleDtitemid1: TcxGridDBColumn;
    cgvCoupleDtitemid2: TcxGridDBColumn;
    cgvCoupleDtitemid3: TcxGridDBColumn;
    cgvCoupleDtitemid4: TcxGridDBColumn;
...
uses
  untConstanta, untProcedure, dtmGlobal, dtmGeneral,
...
begin
  ...
  dbeQty.Properties.DisplayFormat :=
    dmGlobal.SettingGlobal.DisplayFormatQty;

  dbeTotalCOGS.Properties.DisplayFormat :=
...
begin
  ...
  ExecuteQuery(qryUpdateCOGSCoupleHd, False);
