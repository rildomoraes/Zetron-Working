object fmPurchaseReturnCashPayment: TfmPurchaseReturnCashPayment
  Left = 388
  Top = 205
  ...
  object gbInvoice: TcxGroupBox
    ...
    object lblPurchaseReturnDate: TDBText
      Left = 97
      Top = 29
      Width = 110
      Height = 13
      AutoSize = True
      DataField = 'purchasereturndate'
      DataSource = dsPrevPurchaseReturnHd
      Transparent = True
    end
    ...
    object lbPurchaseReturnId: TDBText
      Left = 97
      Top = 48
      Width = 94
      Height = 13
      AutoSize = True
      DataField = 'purchasereturnid'
      DataSource = dsPrevPurchaseReturnHd
      Transparent = True
    end
    ...
    object lblVendorPurchaseReturnId: TDBText
      Left = 97
      Top = 67
      Width = 130
      Height = 13
      AutoSize = True
      DataField = 'vendorpurchasereturnid'
      DataSource = dsPrevPurchaseReturnHd
      Transparent = True
    end
    ...
    object dbeDepositBalance: TcxDBCurrencyEdit
      Left = 316
      Top = 45
      TabStop = False
      BeepOnEnter = False
      DataBinding.DataField = 'depositbalance'
      DataBinding.DataSource = dsPrevPurchaseReturnHd
  ...
  object gbTotalAmount: TcxGroupBox
    Left = 0
    Top = 97
    Align = alLeft
    Caption = 'Tagihan'
    ...
    object dbeDiscAmount1: TcxDBCurrencyEdit
      Left = 167
      Top = 43
      TabStop = False
      BeepOnEnter = False
      DataBinding.DataField = 'discamount'
      DataBinding.DataSource = dsPrevPurchaseReturnHd
      Properties.ReadOnly = True
      Style.Color = clWindow
      Style.Edges = []
    ...
    object dbeDiscAmount2: TcxDBCurrencyEdit
      Left = 167
      Top = 61
      TabStop = False
      BeepOnEnter = False
      DataBinding.DataField = 'discamount2'
      DataBinding.DataSource = dsPrevPurchaseReturnHd
      Properties.ReadOnly = True
      Style.Color = clWindow
      Style.Edges = []
    ...
    object dbeVoucher: TcxDBCurrencyEdit
      Left = 95
      Top = 80
      TabStop = False
      BeepOnEnter = False
    ...
    object dbeTax: TcxDBCurrencyEdit
      Left = 95
      Top = 97
      TabStop = False
      BeepOnEnter = False
  ...
  object gbPayment: TcxGroupBox
    ...
    object dbeOutstandingTotalAmount: TcxDBCurrencyEdit
      ...
      TabStop = False
      BeepOnEnter = False
      DataBinding.DataField = 'outstandingtotalamount'
      DataBinding.DataSource = dsPrevPurchaseReturnHd
      ParentFont = False
      Properties.ReadOnly = True
      Style.Color = clWindow
    ...
    object lcbCurrencyId: TcxExtLookupComboBox
      Left = 138
      Top = 63
      ParentFont = False
    ...
    object edtKurs: TcxCalcEdit
      Left = 221
      Top = 63
      BeepOnEnter = False
      EditValue = 0.000000000000000000
      ParentFont = False
      Properties.OnEditValueChanged = edtPaymentAmountPropertiesEditValueChanged
      Style.Color = clWindow
      Style.Font.Charset = ANSI_CHARSET
      Style.Font.Color = clWindowText
      Style.Font.Height = -13
    ...
    object edtPaymentAmount: TcxCurrencyEdit
      Left = 138
      Top = 105
      BeepOnEnter = False
      EditValue = 0.000000000000000000
  ...
  object dsPrevPurchaseReturnHd: TDataSource
    DataSet = qryPrevPurchaseReturnHd
    Left = 472
    Top = 24
  end
  object qryPrevPurchaseReturnHd: TUniQuery
    Connection = dmGlobal.conReadOnly
    SQL.Strings = (
      'select a.*, b.VendorName, b.DepositBalance'
  ...
  object qryInsPurchaseReturnPaymentHd: TUniQuery
    Connection = dmGlobal.conGlobal
    SQL.Strings = (
      'insert into PurchaseReturnPaymentHd'
      '  (PurchaseReturnPaymentId, PurchaseReturnPaymentDate, VendorId,'
      '  StatusApprove, FlagAutomatic, EmployeeId)'
      'values'
      
        '  (:PurchaseReturnPaymentId, :PurchaseReturnPaymentDate, :Vendor' +
        'Id, 1, 1, :EmployeeId)')
    Left = 472
    Top = 56
    ParamData = <
      ...
      item
        DataType = ftUnknown
        Name = 'PurchaseReturnPaymentDate'
      end
      item
        DataType = ftUnknown
        Name = 'VendorId'
  ...
  object qryInsPurchaseReturnPaymentDt: TUniQuery
    Connection = dmGlobal.conGlobal
    SQL.Strings = (
      'insert into PurchaseReturnPaymentDt'
      
        '  (PurchaseReturnPaymentId, No, PurchaseReturnId, PaymentTypeId,' +
        ' '
      '  Amount, EmployeeId, CurrencyId, Kurs)'
      'values'
      
        '  (:PurchaseReturnPaymentId, 1, :PurchaseReturnId, :PaymentTypeI' +
        'd, '
      '  :Amount, :EmployeeId, :CurrencyId, :Kurs)')
    Left = 504
    Top = 56
