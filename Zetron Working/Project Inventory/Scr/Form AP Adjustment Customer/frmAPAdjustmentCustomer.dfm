inherited fmAPAdjustmentCustomer: TfmAPAdjustmentCustomer
  Caption = 'Adjustment Kurs - Hutang Customer'
  ExplicitWidth = 320
  ExplicitHeight = 240
  PixelsPerInch = 96
  TextHeight = 13
    ...
    inherited dxLayoutDockSite2: TdxLayoutDockSite
      ...
      inherited pnlInfo: TdxDockPanel
        ...
        object dbeTransactionDate: TcxDBDateEdit
          ...
          Top = 7
          BeepOnEnter = False
          DataBinding.DataField = 'apadjustmentcustomerdate'
        ...
        object dbeTransactionId: TcxDBTextEdit
          ...
          Top = 25
          BeepOnEnter = False
          DataBinding.DataField = 'apadjustmentcustomerid'
          DataBinding.DataSource = dsDefault
  ...
  inherited dsDefault: TDataSource
    DataSet = qryAPAdjustmentCustomer
  end
  object qryAPAdjustmentCustomer: TUniQuery
    Connection = dmGlobal.conGlobal
    SQL.Strings = (
      'select * '
      'from APAdjustmentCustomer'
      'where extract(year from APAdjustmentCustomerDate) = :Year'
      'and extract(month from APAdjustmentCustomerDate) = :Month')
    BeforeInsert = qryAPAdjustmentCustomerBeforeInsert
    BeforeEdit = qryAPAdjustmentCustomerBeforeEdit
    BeforePost = qryAPAdjustmentCustomerBeforePost
    AfterPost = qryAPAdjustmentCustomerAfterPost
    AfterCancel = qryAPAdjustmentCustomerAfterCancel
    OnNewRecord = qryAPAdjustmentCustomerNewRecord
    Left = 136
    Top = 112
    ParamData = <
      item
