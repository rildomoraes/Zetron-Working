object fmSalesReturnCashPayment: TfmSalesReturnCashPayment
  Left = 388
  Top = 205
  ...
  object gbInvoice: TcxGroupBox
    ...
    object lblSalesReturnDate: TDBText
      Left = 97
      Top = 29
      Width = 91
      Height = 13
      AutoSize = True
      DataField = 'salesreturndate'
      DataSource = dsPrevSalesReturnHd
      Transparent = True
    end
    ...
    object lblSalesReturnId: TDBText
      Left = 97
      Top = 48
      Width = 77
      Height = 13
      AutoSize = True
      DataField = 'salesreturnid'
      DataSource = dsPrevSalesReturnHd
      Transparent = True
    end
    ...
    object lblSalesReturnIdInternal: TDBText
      Left = 97
      Top = 67
      Width = 112
      Height = 13
      AutoSize = True
      DataField = 'salesreturnidinternal'
      DataSource = dsPrevSalesReturnHd
      Transparent = True
    end
  ...
  object gbTotalAmount: TcxGroupBox
    ...
    object dbeAmount: TcxDBCurrencyEdit
      ...
      DataBinding.DataSource = dsPrevSalesReturnHd
      Properties.ReadOnly = True
      Style.BorderColor = clWindowFrame
      Style.Color = clWindow
      Style.Edges = []
  ...
  object dsPrevSalesReturnHd: TDataSource
    DataSet = qryPrevSalesReturnHd
    Left = 472
    Top = 24
  end
  object qryPrevSalesReturnHd: TUniQuery
    Connection = dmGlobal.conReadOnly
    SQL.Strings = (
      'select '
      '  a.*, '
      '  b.CustomerName, b.DepositBalance'
  ...
  object qryInsSalesReturnPaymentHd: TUniQuery
    Connection = dmGlobal.conGlobal
    SQL.Strings = (
      'insert into SalesReturnPaymentHd'
      '  (SalesReturnPaymentId, SalesReturnPaymentDate, CustomerId,'
  ...
  object qryInsSalesReturnPaymentDt: TUniQuery
    Connection = dmGlobal.conGlobal
    SQL.Strings = (
      'insert into SalesReturnPaymentDt'
      '  (SalesReturnPaymentId, No, SalesReturnId, PaymentTypeId, '
      '  Amount, EmployeeId, CurrencyId, Kurs)'
      'values'
      '  (:SalesReturnPaymentId, 1, :SalesReturnId, :PaymentTypeId, '
      '  :Amount, :EmployeeId, :CurrencyId, :Kurs)')
    Left = 504
    Top = 56
    ParamData = <
