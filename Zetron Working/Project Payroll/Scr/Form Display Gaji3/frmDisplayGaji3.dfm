inherited fmDisplayGaji3: TfmDisplayGaji3
  ...
  object qryDisplayGaji3: TADOQuery
    ...
    SQL.Strings = (
        ...
        'c.nama,d.kodejabatan,d.namajabatan,a.shift,a.bruto,a.potongan,a.' +
        'netto,a.tglcetak'
      ...
      ')'
      'and substring(b.nopayroll,1,1)='#39'P'#39
      
        'group by a.notransaksipengambilan,a.tglpengambilanpayroll,c.nope' +
        'g,c.nama,d.kodejabatan,d.namajabatan,a.shift,a.bruto,a.potongan,' +
        'a.netto,a.tglcetak'
      '')
    Left = 168
    Top = 256
