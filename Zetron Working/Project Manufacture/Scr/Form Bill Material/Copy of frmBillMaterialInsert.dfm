object fmBillMaterialInsert: TfmBillMaterialInsert
  ...
  object gbParent: TcxGroupBox
    ...
    object lcbItemIdSubRoot: TcxExtLookupComboBox
      Left = 92
      Top = 61
      TabStop = False
    ...
    object lcbItemIdRoot: TcxExtLookupComboBox
      Left = 92
      Top = 37
      TabStop = False
      Properties.View = dmInventory.cgvPrevItem
  ...
  object gbChild: TcxGroupBox
    ...
    object pnlTop: TPanel
      ...
      object lcbItemTypeId: TcxExtLookupComboBox
        Left = 116
        Top = 3
        BeepOnEnter = False
        Properties.View = dmInventory.cgvItemType
        Properties.KeyFieldNames = 'ItemTypeId'
        Properties.ListFieldItem = dmInventory.cgvItemTypeItemTypeName
        Properties.OnEditValueChanged = lcbItemTypeIdPropertiesEditValueChanged
        EditValue = '0'
        TabOrder = 0
        Width = 169
      end
  ...
  object qryInsBillMaterialDt: TADOQuery
  ...
  object IvPropDevExpress1: TIvPropDevExpress
    About = 'Created by Ivan Handoyo'
    AutoLoad = True
    OptionsView.GridLineColor = clDefault
    OptionsView.GridLines = glBoth
    OptionsView.GridGroupRowStyle = grsStandard
    OptionsCustomize.ColumnsQuickCustomization = False
    OptionsCustomize.BandsQuickCustomization = False
    SortByDisplayText = True
    Version = '1.4'
    Language = lIndonesian
