object fmBTBEntry: TfmBTBEntry
  ...
  object qryTallySheetGrade: TADODataSet
    ...
    CommandText = 
      ...
      'lySheetGradeCode'#13#10'and GradeResultIdRef=:GradeResultIdRef'#13#10
    Parameters = <
      item
  ...
  object qryPrevItemPO: TADODataSet
    ...
    CommandText = 
      ...
      'ft join Item b on a.itemid = b.itemid'#13#10'where a.PurchaseOrderId =' +
      ' :PurchaseOrderId'#13#10
    Parameters = <
      item
  ...
  object qryCekUkuran: TADODataSet
    Connection = dmGlobal.conGlobal
    CursorType = ctStatic
    CommandText = 
      'select distinct a.itemid,a.TCut,LCut,PCut,TInv,LInv,LInvInterval' +
      ',PInv,PInvInterval'#13#10'from PurchaseOrderDt a '#13#10'where a.PurchaseOrd' +
      'erId = :PurchaseOrderId'#13#10'and a.itemid=:itemid'#13#10
    Parameters = <
      item
        Name = 'PurchaseOrderId'
        Attributes = [paSigned]
