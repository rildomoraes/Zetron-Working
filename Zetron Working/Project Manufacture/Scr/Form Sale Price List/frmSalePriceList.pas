...
type
  TfmSalePriceList = class(TFormUniDB)
    dsPrice: TDataSource;
    cgPrice: TcxGrid;
...
var
  fmSalePriceList: TfmSalePriceList;
...
procedure TfmSalePriceList.ActProsesExecute(Sender: TObject);
var
  i, ALevel: integer;
...
procedure TfmSalePriceList.cbLevelPropertiesEditValueChanged(Sender: TObject);
begin
  inherited;
  if cbLevel.Checked then
  begin
...
procedure TfmSalePriceList.chnaikPropertiesEditValueChanged(Sender: TObject);
begin
  inherited;
  if chnaik.Checked then
  begin
...
procedure TfmSalePriceList.dsPriceDataChange(Sender: TObject; Field: TField);
begin
  inherited;
  if (Field = nil) then
    Exit;
...
procedure TfmSalePriceList.InitForm;
begin
  inherited;
...
procedure TfmSalePriceList.RefreshAll;
begin
  inherited;
