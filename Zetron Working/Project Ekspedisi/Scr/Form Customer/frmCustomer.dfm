inherited fmCustomer: TfmCustomer
        ...
        object cxPageControl1: TcxPageControl
          ...
          object tsGeneral: TcxTabSheet
            ...
            object dblcCustomerCategory: TcxDBExtLookupComboBox
              ...
              DataBinding.DataSource = dsDefault
              Properties.View = dmEkspedisi.cgvPrevCustomerCategory
              Properties.KeyFieldNames = 'CustomerCategoryId'
              Properties.ListFieldItem = dmEkspedisi.cgvPrevCustomerCategoryCategoryName
              TabOrder = 2
              Width = 185
            end
          ...
          object tsShipping: TcxTabSheet
            ...
            object cgMerek: TcxGrid
              ...
              Align = alClient
              TabOrder = 0
              object cgvMerek: TcxGridDBTableView
                NavigatorButtons.ConfirmDelete = False
                NavigatorButtons.First.Visible = False
                NavigatorButtons.PriorPage.Visible = False
                NavigatorButtons.Prior.Visible = False
                ...
                NavigatorButtons.GotoBookmark.Visible = False
                NavigatorButtons.Filter.Visible = False
                DataController.DataSource = dsCustomerMerek
                DataController.Summary.DefaultGroupSummaryItems = <>
                DataController.Summary.FooterSummaryItems = <>
                DataController.Summary.SummaryGroups = <>
                NewItemRow.Visible = True
                OptionsView.Navigator = True
                OptionsView.GroupByBox = False
                object cgvMerekMerekId: TcxGridDBColumn
                  Caption = 'Merek Id'
                  DataBinding.FieldName = 'MerekId'
                  Visible = False
                end
                object cgvMerekMerekCode: TcxGridDBColumn
                  Caption = 'Kode Merek'
                  DataBinding.FieldName = 'MerekCode'
                end
                object cgvMerekMerekName: TcxGridDBColumn
                  Caption = 'Nama Merek'
                  DataBinding.FieldName = 'MerekName'
                end
                object cgvMerekRouteId: TcxGridDBColumn
                  Caption = 'Jurusan'
              ...
              object cgMerekLevel1: TcxGridLevel
                GridView = cgvMerek
              end
            end
          end
  ...
  inherited dsDefault: TDataSource [4]
    DataSet = dmEkspedisi.qryCustomer
  end
