inherited fmCounter: TfmCounter
            ...
            object cxTabSheet1: TcxTabSheet
              ...
              object cxGrid3: TcxGrid
                ...
                object cxGridDBTableView1: TcxGridDBTableView
                  ...
                  NavigatorButtons.GotoBookmark.Visible = False
                  NavigatorButtons.Filter.Visible = False
                  DataController.DataSource = dsLogCounter
                  DataController.Summary.DefaultGroupSummaryItems = <>
                  DataController.Summary.FooterSummaryItems = <>
                  DataController.Summary.SummaryGroups = <>
                  OptionsView.Navigator = True
                  ...
                  object cxGridDBTableView1TransactionDate: TcxGridDBColumn
                  ...
                  object cxGridDBTableView1TableName: TcxGridDBColumn
                  ...
                  object cxGridDBTableView1KeyField: TcxGridDBColumn
  ...
  object qryCounterDt1: TADOQuery
    ...
    AfterPost = qryCounterDt1AfterPost
    BeforeDelete = qryCounterDt1BeforeDelete
    AfterDelete = qryCounterDt1AfterDelete
  ...
  object qryCounterHd: TADOQuery
    Connection = dmGlobal.conGlobal
    CursorType = ctStatic
    BeforePost = qryCounterHdBeforePost
    AfterPost = qryCounterHdAfterPost
    BeforeDelete = qryCounterHdBeforeDelete
    AfterDelete = qryCounterHdAfterDelete
    Parameters = <>
    SQL.Strings = (
      'select *'
      'from CounterHd')
  ...
  object qryLogCounter: TADOQuery
    Connection = dmGlobal.conGlobal
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      'select * from TransactionLog'
      'where TableName='#39'CounterHd'#39' or TableName='#39'CounterDt1'#39
      'order by TransactionDate')
    Left = 336
    Top = 288
  end
  object dsLogCounter: TDataSource
    DataSet = qryLogCounter
    Left = 336
    Top = 328
  end
end
