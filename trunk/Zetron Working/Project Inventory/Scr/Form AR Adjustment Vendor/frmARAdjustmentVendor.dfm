inherited fmARAdjustmentVendor: TfmARAdjustmentVendor
  Caption = 'Adjustment Kurs - Piutang Vendor'
  ExplicitWidth = 320
  ExplicitHeight = 240
  PixelsPerInch = 96
  TextHeight = 13
    ...
    inherited dxLayoutDockSite2: TdxLayoutDockSite
      ...
      inherited pnlInfo: TdxDockPanel
        ...
        object dbeTransactionDate: TcxDBDateEdit
          ...
          Top = 7
          BeepOnEnter = False
          DataBinding.DataField = 'aradjustmentvendordate'
        ...
        object dbeTransactionId: TcxDBTextEdit
          ...
          Top = 25
          BeepOnEnter = False
          DataBinding.DataField = 'aradjustmentvendorid'
          DataBinding.DataSource = dsDefault
  ...
  inherited dsDefault: TDataSource
    DataSet = qryARAdjustmentVendor
  end
  object qryARAdjustmentVendor: TUniQuery
    Connection = dmGlobal.conGlobal
    SQL.Strings = (
      'select * '
      'from ARAdjustmentVendor'
      'where extract(year from ARAdjustmentVendorDate) = :Year'
      'and extract(month from ARAdjustmentVendorDate) = :Month')
    BeforeInsert = qryARAdjustmentVendorBeforeInsert
    BeforeEdit = qryARAdjustmentVendorBeforeEdit
    BeforePost = qryARAdjustmentVendorBeforePost
    AfterPost = qryARAdjustmentVendorAfterPost
    AfterCancel = qryARAdjustmentVendorAfterCancel
    OnNewRecord = qryARAdjustmentVendorNewRecord
    Left = 136
    Top = 112
    ParamData = <
      item
