...
type
  TfmDisplaySalesOrder = class(TFormUniDisplayPeriod)
    dsDisplay: TDataSource;
    dsDisplayDt: TDataSource;
    cgDisplay: TcxGrid;
    cgvDisplay: TcxGridDBTableView;
    cgvDisplaystatusapprove: TcxGridDBColumn;
    cgvDisplaySalesOrderid: TcxGridDBColumn;
    cgvDisplaySalesOrderdate: TcxGridDBColumn;
    cgvDisplayCustomerSalesOrderid: TcxGridDBColumn;
    ...
    cgvDisplayDtSalesOrderid: TcxGridDBColumn;
...
var
  fmDisplaySalesOrder: TfmDisplaySalesOrder;
...
procedure TfmDisplaySalesOrder.InitForm;
begin
  inherited;
...
procedure TfmDisplaySalesOrder.MonthYearValueChange(Sender: TObject);
begin
  inherited;
...
procedure TfmDisplaySalesOrder.RefreshAll;
begin
  inherited;
