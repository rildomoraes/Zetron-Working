inherited fmAPAdjustmentVendor: TfmAPAdjustmentVendor
  Caption = 'Adjustment Kurs - Hutang Vendor'
  ExplicitWidth = 320
  ExplicitHeight = 240
  PixelsPerInch = 96
  TextHeight = 13
    ...
    inherited dxLayoutDockSite2: TdxLayoutDockSite
      ...
      inherited pnlInfo: TdxDockPanel
        ...
        object dbeTransactionDate: TcxDBDateEdit
          ...
          Top = 7
          BeepOnEnter = False
          DataBinding.DataField = 'apadjustmentvendordate'
        ...
        object dbeTransactionId: TcxDBTextEdit
          ...
          Top = 25
          BeepOnEnter = False
          DataBinding.DataField = 'apadjustmentvendorid'
          DataBinding.DataSource = dsDefault
  ...
  inherited dsDefault: TDataSource
    DataSet = qryAPAdjustmentVendor
  end
  object qryAPAdjustmentVendor: TUniQuery
    Connection = dmGlobal.conGlobal
    SQL.Strings = (
      'select * '
      'from APAdjustmentVendor'
      'where extract(year from APAdjustmentVendorDate) = :Year'
      'and extract(month from APAdjustmentVendorDate) = :Month')
    BeforeInsert = qryAPAdjustmentVendorBeforeInsert
    BeforeEdit = qryAPAdjustmentVendorBeforeEdit
    BeforePost = qryAPAdjustmentVendorBeforePost
    AfterPost = qryAPAdjustmentVendorAfterPost
    AfterCancel = qryAPAdjustmentVendorAfterCancel
    OnNewRecord = qryAPAdjustmentVendorNewRecord
    Left = 136
    Top = 112
    ParamData = <
      item
