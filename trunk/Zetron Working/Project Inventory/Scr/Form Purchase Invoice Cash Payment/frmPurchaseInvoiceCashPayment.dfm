object fmPurchaseInvoiceCashPayment: TfmPurchaseInvoiceCashPayment
  Left = 388
  Top = 205
  ...
  object gbInvoice: TcxGroupBox
    ...
    object lblPurchaseInvoiceDate: TDBText
      Left = 97
      Top = 29
      Width = 113
      Height = 13
      ...
      DataSource = dsPrevPurchaseInvoice
      Transparent = True
    end
    ...
    object lbPurchaseInvoiceId: TDBText
      Left = 97
      Top = 48
      Width = 97
      Height = 13
    ...
    object lblVendorPurchaseInvoiceId: TDBText
      Left = 97
      Top = 67
      Width = 133
      Height = 13
      AutoSize = True
      DataField = 'vendorpurchaseinvoiceid'
      DataSource = dsPrevPurchaseInvoice
      Transparent = True
    end
    ...
    object dbeDepositBalance: TcxDBCurrencyEdit
      ...
      DataBinding.DataSource = dsPrevPurchaseInvoice
  ...
  object dsPrevPurchaseInvoice: TDataSource
    DataSet = qryPrevPurchaseInvoice
    Left = 472
    Top = 24
  end
  object qryPrevPurchaseInvoice: TUniQuery
  ...
  object qryInsPurchasePayment: TUniQuery
    Connection = dmGlobal.conGlobal
    SQL.Strings = (
      'insert into PurchasePayment'
      
        '  (PurchasePaymentId, PurchasePaymentDate, VendorId, StatusAppro' +
        've, EmployeeId)'
      'values'
      
        '  (:PurchasePaymentId, :PurchasePaymentDate, :VendorId, 1, :Empl' +
        'oyeeId)')
    Left = 472
    Top = 56
    ParamData = <
  ...
  object qryInsPurchasePaymentDt: TUniQuery
    Connection = dmGlobal.conGlobal
    SQL.Strings = (
      'insert into PurchasePaymentDt'
      '  (PurchasePaymentId, No, PurchaseInvoiceId, PaymentTypeId, '
      '  Amount, EmployeeId, CurrencyId, Kurs)'
      'values'
      '  (:PurchasePaymentId, 1, :PurchaseInvoiceId, :PaymentTypeId, '
      '  :Amount, :EmployeeId, :CurrencyId, :Kurs)')
    Left = 504
    Top = 56
    ParamData = <
