...
/* Created on:     31/12/2008 11:48:31 AM                       */
/*==============================================================*/
...
if exists (select 1
          from sysobjects
          where id = object_id('TR_tbIMAssemblyHd_UI')
          and type = 'TR')
   drop trigger TR_tbIMAssemblyHd_UI
go

if exists (select 1
          from sysobjects
          where id = object_id('TR_tbIMAssemblyTransactionDt_D')
          and type = 'TR')
   drop trigger TR_tbIMAssemblyTransactionDt_D
go

if exists (select 1
          from sysobjects
          where id = object_id('TR_tbIMAssemblyTransactionDt_UI')
          and type = 'TR')
   drop trigger TR_tbIMAssemblyTransactionDt_UI
go

if exists (select 1
          from sysobjects
          where id = object_id('TR_tbIMAssemblyTransactionHd_U')
          and type = 'TR')
   drop trigger TR_tbIMAssemblyTransactionHd_U
go

if exists (select 1
          from sysobjects
          where id = object_id('TR_tbIMAssemblyTransactionSupplies_D')
          and type = 'TR')
   drop trigger TR_tbIMAssemblyTransactionSupplies_D
go

if exists (select 1
          from sysobjects
          where id = object_id('TR_tbIMAssemblyTransactionSupplies_UI')
          and type = 'TR')
   drop trigger TR_tbIMAssemblyTransactionSupplies_UI
go
...
if exists (select 1
   from dbo.sysreferences r join dbo.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('tbIMAssemblyDt') and o.name = 'FK_IMAssemblyDt_IMSupplies')
alter table tbIMAssemblyDt
   drop constraint FK_IMAssemblyDt_IMSupplies
go

if exists (select 1
   from dbo.sysreferences r join dbo.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('tbIMAssemblyDt') and o.name = 'FK_IMAssemblyHd_IMAssemblyDt')
alter table tbIMAssemblyDt
   drop constraint FK_IMAssemblyHd_IMAssemblyDt
go

if exists (select 1
   from dbo.sysreferences r join dbo.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('tbIMAssemblyTransactionDt') and o.name = 'FK_IMAssemblyTransactionDt_IMAssemblyHd')
alter table tbIMAssemblyTransactionDt
   drop constraint FK_IMAssemblyTransactionDt_IMAssemblyHd
go
...
if exists (select 1
   from dbo.sysreferences r join dbo.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('tbIMAssemblyTransactionSupplies') and o.name = 'FK_tbIMAssemblyTransactionSupplies_tbIMAssemblyTransactionDt')
alter table tbIMAssemblyTransactionSupplies
   drop constraint FK_tbIMAssemblyTransactionSupplies_tbIMAssemblyTransactionDt
go

if exists (select 1
   from dbo.sysreferences r join dbo.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('tbIMAssemblyTransactionSupplies') and o.name = 'FK_tbIMAssemblyTransactionSupplies_tbIMSupplies')
alter table tbIMAssemblyTransactionSupplies
   drop constraint FK_tbIMAssemblyTransactionSupplies_tbIMSupplies
go
...
if exists (select 1
            from  sysobjects
           where  id = object_id('tbACPaymentType')
            and   type = 'U')
   drop table tbACPaymentType
go
...
if exists (select 1
            from  sysindexes
           where  id    = object_id('tbIMAssemblyDt')
            and   name  = 'ID_tbIMAssemblyDt'
            and   indid > 0
            and   indid < 255)
   drop index tbIMAssemblyDt.ID_tbIMAssemblyDt
go
...
if exists (select 1
           ...
           where  id = object_id('tbIMAssemblyDt')
            and   type = 'U')
   drop table tbIMAssemblyDt
go

if exists (select 1
            from  sysindexes
           where  id    = object_id('tbIMAssemblyHd')
            and   name  = 'ID_tbIMAssembly'
            and   indid > 0
            and   indid < 255)
   drop index tbIMAssemblyHd.ID_tbIMAssembly
go
...
if exists (select 1
            from  sysindexes
           where  id    = object_id('tbIMAssemblyTransactionSupplies')
            and   name  = 'ID_tbIMAssemblyTransactionSupplies'
            and   indid > 0
            and   indid < 255)
   drop index tbIMAssemblyTransactionSupplies.ID_tbIMAssemblyTransactionSupplies
go
...
create table PositionAccess (
   ...
   constraint PK_POSITIONACCESS primary key nonclustered (ProgramId, MenuId, ActionName)
)
go
...
/*==============================================================*/
/* Table: tbACPaymentType                                       */
/*==============================================================*/
create table tbACPaymentType (
   vcIdPaymentType      varchar(10)          not null,
   vcPaymentName        varchar(50)          not null,
   chFlagPPApprovalType1 Flag                 null,
   chFlagPPApprovalType2 Flag                 null,
   chFlagSPApprovalType1 Flag                 null,
   chFlagSPApprovalType2 Flag                 null,
   dtSystemStamp        StampAuto            not null,
   constraint PK_TBACPAYMENTTYPE primary key nonclustered (vcIdPaymentType)
)
go
...
create table tbGNPaymentType (
   ...
   chFlagSPApprovalType1 Flag                 null,
   chFlagSPApprovalType2 Flag                 null,
   chFlagPPView         Flag                 null,
   chFlagSPView         Flag                 null,
   vcEmployeeName       varchar(40)          null,
   chFlagInactive       Flag                 null,
   chFlagFix            Flag                 null,
   dtSystemStamp        StampAuto            not null,
...
/*==============================================================*/
/* Table: tbIMAssemblyDt                                        */
/*==============================================================*/
create table tbIMAssemblyDt (
   inNo                 integer              null,
   vcIdAssemblySupplies varchar(20)          not null,
   vcIdSupplies         varchar(20)          not null,
   inQty                integer              null,
   dtSystemStamp        StampAuto            not null,
   constraint PK_TBIMASSEMBLYDT primary key nonclustered (vcIdAssemblySupplies, vcIdSupplies)
)
go

/*==============================================================*/
/* Index: ID_tbIMAssemblyDt                                     */
/*==============================================================*/
create unique index ID_tbIMAssemblyDt on tbIMAssemblyDt (
vcIdAssemblySupplies ASC,
vcIdSupplies ASC
)
go

/*==============================================================*/
/* Table: tbIMAssemblyHd                                        */
/*==============================================================*/
create table tbIMAssemblyHd (
   vcIdAssemblySupplies varchar(20)          not null,
   vcAssemblySuppliesName varchar(50)          null,
   vcIdSuppliesCategory varchar(20)          not null,
   vcIdUnitOfMeasure    varchar(3)           not null,
   ...
   vcEmployeeName       varchar(40)          null,
   dtSystemStamp        StampAuto            not null,
   constraint PK_TBIMASSEMBLYHD primary key nonclustered (vcIdAssemblySupplies)
)
go

/*==============================================================*/
/* Index: ID_tbIMAssembly                                       */
/*==============================================================*/
create unique index ID_tbIMAssembly on tbIMAssemblyHd (
vcIdAssemblySupplies ASC
)
go
...
create table tbIMAssemblyTransactionDt (
   ...
   dcAmount             money                null,
   constraint PK_TBIMASSEMBLYTRANSACTIONDT primary key nonclustered (vcIdAssemblyTransaction, vcIdAssemblySupplies)
)
go
...
create table tbIMAssemblyTransactionHd (
   vcIdAssemblyTransaction varchar(12)          not null,
   vcIdWarehouse        varchar(10)          null,
   dtAssemblyTransactionDate datetime             null,
...
/*==============================================================*/
/* Table: tbIMAssemblyTransactionSupplies                       */
/*==============================================================*/
create table tbIMAssemblyTransactionSupplies (
   inNo                 integer              not null,
   vcIdAssemblyTransaction varchar(12)          not null,
   vcIdAssemblySupplies varchar(20)          not null,
   vcIdSupplies         varchar(20)          not null,
   inQty                integer              null,
   dcPrice              Currency             null,
   constraint PK_TBIMASSEMBLYTRANSACTIONSUPP primary key nonclustered (vcIdAssemblyTransaction, vcIdAssemblySupplies, vcIdSupplies)
)
go

/*==============================================================*/
/* Index: ID_tbIMAssemblyTransactionSupplies                    */
/*==============================================================*/
create unique index ID_tbIMAssemblyTransactionSupplies on tbIMAssemblyTransactionSupplies (
vcIdAssemblyTransaction ASC,
vcIdSupplies ASC,
vcIdAssemblySupplies ASC
)
...
create table tbIMOtherTransactionHd (
   ...
   vcIdTransactionType  varchar(10)          null,
   vcIdWarehouseSource  varchar(10)          null,
...
execute sp_bindefault Zero, 'tbIMReceivingRecordHd.inCounterPrint'
go
...
alter table tbIMAssemblyDt
   add constraint FK_IMAssemblyDt_IMSupplies foreign key (vcIdSupplies)
      references tbIMSupplies (vcIdSupplies)
         on update cascade
go

alter table tbIMAssemblyDt
   add constraint FK_IMAssemblyHd_IMAssemblyDt foreign key (vcIdAssemblySupplies)
      references tbIMAssemblyHd (vcIdAssemblySupplies)
         on update cascade on delete cascade
go

alter table tbIMAssemblyTransactionDt
   add constraint FK_IMAssemblyTransactionDt_IMAssemblyHd foreign key (vcIdAssemblySupplies)
      references tbIMAssemblyHd (vcIdAssemblySupplies)
         on update cascade
go
...
alter table tbIMAssemblyTransactionSupplies
   add constraint FK_tbIMAssemblyTransactionSupplies_tbIMAssemblyTransactionDt foreign key (vcIdAssemblyTransaction, vcIdAssemblySupplies)
      references tbIMAssemblyTransactionDt (vcIdAssemblyTransaction, vcIdAssemblySupplies)
         on update cascade
go

alter table tbIMAssemblyTransactionSupplies
   add constraint FK_tbIMAssemblyTransactionSupplies_tbIMSupplies foreign key (vcIdSupplies)
      references tbIMSupplies (vcIdSupplies)
         on update cascade
go
...
go
 ...
 /*  Insert trigger "TR_tbIMAssemblyHd_UI" for table "tbIMAssemblyHd"
   Table  : TbIMAssemblyHd (After Update - Insert)
   Desc   : Trigger for auto update record if new record inserted
   Create : Novien */
   
create trigger TR_tbIMAssemblyHd_UI on tbIMAssemblyHd
with encryption  
for update, insert as
begin
  declare
     @IdAssemblySuppliesOld varchar(20),
     @IdAssemblySupplies varchar(20),
     @AssemblySuppliesName varchar(50),
     @IdSuppliesCategory varchar(20),
     @IdUnitOfMeasure varchar(3),
     @Merk varchar(15),
     @Tipe varchar(40),
     @MinStock int,
     @Notes varchar(100),
  ...
  /* get old record */
  select
    @IdAssemblySuppliesOld = vcIdAssemblySupplies
  from Deleted 
       
  /* get new record */
  select
    @IdAssemblySupplies = vcIdAssemblySupplies,
    @AssemblySuppliesName = vcAssemblySuppliesName,
    @IdSuppliesCategory = vcIdSuppliesCategory,
    @IdUnitOfMeasure = vcIdUnitOfMeasure,
    @Merk = vcMerk,
    @Tipe = vcType,
    @MinStock = inMinStock,
    @Notes = vcNotes,
  ...
  if((@IdAssemblySuppliesOld) <> '') and ((@IdAssemblySupplies) <> '')
  begin
    update tbIMSupplies
      set vcIdSupplies = @IdAssemblySupplies,
          vcSuppliesName = @AssemblySuppliesName,
          vcIdSuppliesCategory = @IdSuppliesCategory,
          vcIdUnitOfMeasure = @IdUnitOfMeasure,
          vcMerk = @Merk,
          vcType = @Tipe,
          inMinStock = @MinStock,
          vcNotes = @Notes,
          vcEmployeeName = @EmployeeName,
          dtSystemStamp = getdate()
    where vcIdSupplies = @IdAssemblySuppliesOld
    if @@RowCount = 0
      insert into tbIMSupplies (vcIdSupplies, vcSuppliesName, vcIdSuppliesCategory,
        vcIdUnitOfMeasure, vcMerk, vcType, inMinStock, vcNotes, vcEmployeeName, dtSystemStamp)
      values (@IdAssemblySupplies, @AssemblySuppliesName, @IdSuppliesCategory,
        @IdUnitOfMeasure, @Merk, @Tipe, @MinStock, @Notes, @EmployeeName, getdate())
  end 
  else
    if(@IdAssemblySupplies) = ''
      insert into tbIMSupplies (vcIdSupplies, vcSuppliesName, vcIdSuppliesCategory,
        vcIdUnitOfMeasure, vcMerk, vcType, inMinStock, vcNotes, vcEmployeeName, dtSystemStamp)
      values (@IdAssemblySupplies, @AssemblySuppliesName, @IdSuppliesCategory,
        @IdUnitOfMeasure, @Merk, @Tipe, @MinStock, @Notes, @EmployeeName, getdate())
...
create trigger TR_tbIMAssemblyTransactionDt_D on tbIMAssemblyTransactionDt
--with encryption  
for delete as
begin
  declare
    -- variabel transaction 
    @IdAssemblyTransaction varchar(12), @IdSupplies varchar(20), @Qty integer,
    @IdWarehouse varchar(10), @StatusApprove char(1), @AssemblyTransactionType char(1),
    -- others
  ...
  -- get Old info from transaction 
  select
    @IdAssemblyTransaction = vcIdAssemblyTransaction,
    @IdSupplies = vcIdAssemblySupplies,
    @Qty = IsNull(inQty, 0)
  from Deleted
  
  if IsNull(@Qty, 0) > 0 
  begin
    -- get info from tbIMAssemblyTransactionHd
    select 
      @IdWarehouse = vcIdWarehouse,
      @StatusApprove = chStatusApprove,
      @AssemblyTransactionType = chAssemblyTransactionType
...
create trigger TR_tbIMAssemblyTransactionDt_UI on tbIMAssemblyTransactionDt
--with encryption  
for update, insert as
begin
/*  declare
    ...
    @IdWarehouse varchar(10), @StatusApprove char(1), @AssemblyTransactionType char(1),
    -- others
    @SuppliesTemp varchar(20), @StatusReject char(1), @StatusDone char(1) 
  ...
  begin
    ...
    begin
      select 
        @SuppliesTemp = vcIdSupplies
      from tbIMStockOnHandHd
      where vcIdSupplies = @IdSupplies
      and vcIdWarehouse = @IdWarehouse
      
      -- 1.Update tbIMStockOnHandHd (+)
      --if @AssemblyTransactionType = '1'
        --update tbIMStockOnHandHd
        --set inEndQtyReady = inEndQtyReady - @Qty
        --where vcIdWarehouse = @IdWarehouse
        --and vcIdSupplies = @IdSupplies
      ...
      if @AssemblyTransactionType = '0'
        ...
        --begin
          --insert tbIMStockOnHandHd(
            --vcIdSupplies, vcIdWarehouse, inEndQty, inEndQtyReady)
          --values( 
            --@IdSupplies, @IdWarehouse, @Qty, @Qty)
        --end
    end
  end
...
create trigger TR_tbIMAssemblyTransactionHd_U on tbIMAssemblyTransactionHd
--with encryption  
for update as
begin
  declare
    -- variabel transaction 
    @IdAssemblyTransaction varchar(12), @IdSupplies varchar(20), @Qty integer,
    @IdAssemblySupplies varchar(20), @AssemblyQty integer, 
    @IdWarehouse varchar(10), @StatusApprove char(1), @AssemblyTransactionType char(1),
    -- others
    @StatusReject char(1)
  ...
  begin
    declare AssemblyTransactionDetail_Curr cursor for  
      select vcIdAssemblySupplies, IsNull(inQty, 0)
      from tbIMAssemblyTransactionDt
      where vcIdAssemblyTransaction = @IdAssemblyTransaction
      order by inNo

    open AssemblyTransactionDetail_Curr
    
    fetch next from AssemblyTransactionDetail_Curr
    into @IdAssemblySupplies, @AssemblyQty

    while @@FETCH_STATUS = 0
    begin
      -- 1.Update tbIMStockOnHandHd (-) while AssemblyTransactionType = 'Couple' from tbIMAssemblyTransactionDt
      if @AssemblytransactionType = '1'
        update tbIMStockOnHandHd
        set inEndQtyReady = inEndQtyReady - @AssemblyQty
        where vcIdWarehouse = @IdWarehouse
        and vcIdSupplies = @IdAssemblySupplies
      -- 1.Update tbIMStockOnHand (+) while AssemblyTransactionType = 'UnCouple' from tbIMAssemblyTransactionDt
      else
        update tbIMStockOnHandHd
        set inEndQtyReady = inEndQtyReady + @Qty
        where vcIdWarehouse = @IdWarehouse
    ...
    close AssemblyTransactionDetail_Curr
    deallocate AssemblyTransaction_Curr
    
    declare AssemblyTransactionSupplies_Curr cursor for
      select vcIdSupplies, IsNull(SUM(inQty), 0)
      from tbIMAssemblyTransactionSupplies
      group by vcIdAssemblyTransaction, vcIdSupplies
      having vcIdAssemblyTransaction = @IdAssemblyTransaction
      order by vcIdSupplies
        
    open AssemblyTransactionSupplies_Curr
        
    fetch next from AssemblyTransactionSupplies_Curr
    into @IdSupplies, @Qty
        
    while @@FETCH_STATUS = 0
    begin
      if @AssemblyTransactionType = '1'
        -- 1.Update tbIMStockOnHand (+) while AssemblyTransactionType = 'UnCouple' from tbIMAssemblyTransactionSupplies
        update tbIMStockOnHandHd
        set inEndQtyReady = inEndQtyReady + @Qty
        where vcIdWarehouse = @IdWarehouse
        and vcIdSupplies = @IdSupplies
    ...
    close AssemblyTransactionSupplies_Curr
    deallocate AssemblyTransactionSupplies_Curr
...
create trigger TR_tbIMAssemblyTransactionSupplies_D on tbIMAssemblyTransactionSupplies
with encryption  
for delete as
begin
  declare
...
create trigger TR_tbIMAssemblyTransactionSupplies_UI on tbIMAssemblyTransactionSupplies
with encryption  
