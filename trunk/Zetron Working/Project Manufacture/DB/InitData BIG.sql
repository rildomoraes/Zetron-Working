...
values ('ZEMAN_PAC', 'PO_ITEM_01', 'Order Pembelian');
-- Insert Report
insert into Report (ProgramId, ReportId, ReportName)
values ('ZEMAN_PAC', 'PO_ITEM_TAX_01', 'Order Pembelian (Tax)');
...
insert into TransactionType (TransactionTypeId, TransactionTypeCode, TransactionTypeName, StatusTransaction, StatusPairTransaction, FlagFix)
values (3, 'TY003', 'Mutasi Keluar', '1', '1', '1');
insert into TransactionType (TransactionTypeId, TransactionTypeCode, TransactionTypeName, StatusTransaction, StatusPairTransaction, FlagFix)
values (4, 'TY004', 'Mutasi Masuk', '0', '1', '1');

insert into TransactionType (TransactionTypeId, TransactionTypeCode, TransactionTypeName, StatusTransaction, StatusPairTransaction, FlagFix)
values (10, 'TY010', 'Opname Plus', '0', '0', '0');
insert into TransactionType (TransactionTypeId, TransactionTypeCode, TransactionTypeName, StatusTransaction, StatusPairTransaction, FlagFix)
values (11, 'TY011', 'Opname Minus', '1', '0', '0');
