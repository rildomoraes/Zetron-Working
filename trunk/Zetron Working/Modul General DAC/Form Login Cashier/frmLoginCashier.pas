...
uses
  ...
  //Auto Create
  Menus, cxLookAndFeelPainters, cxGraphics, OleServer, ActnList, DB, MemDS,
  DBAccess, Uni, cxDBExtLookupComboBox, cxLookupEdit, cxDBLookupEdit,
  cxDBLookupComboBox, cxTextEdit, cxDropDownEdit, cxCalc, cxControls,
  cxContainer, cxEdit, cxMaskEdit, cxImageComboBox, StdCtrls, cxButtons;
